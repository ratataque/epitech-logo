...
return;}if(mode!=='play'||paused||!v.d)return;let base=q.length?q[q.length-1]:dir;if(v.d.x===-base.x&&v.d.y===-base.y)return;if(q.length<4)q.push( v.d); } ; let pausedAt = 0 ; "78_i" ;const parseKey=
